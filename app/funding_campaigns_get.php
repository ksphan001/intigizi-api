...
try {
    ...
    $sql = "SELECT 
                ...
                fc.cover_image_path, -- Ditambahkan
            ...
            LEFT JOIN investments i ON fc.id = i.campaign_id
            WHERE fc.status = 'active'
            GROUP BY fc.id, fc.title, fc.target_amount, o.name, fc.cover_image_path -- Ditambahkan
